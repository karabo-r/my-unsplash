...
app.use("/api/image", extractToken, ImageRouter);
...
app.get("/", (req, res) => res.send("hello, do you sell cookies?"));
...
// app.post("/api/image/upload", extractToken, async (request, response) => {
...
// app.delete("/api/image/delete/:id", extractToken, async (request, response) => {
// 	const user = request.user;
